  ...
  items: {
    ...
    properties: {
      ...
      title: {
        type: Type.STRING,
        description:
          'A unique and descriptive <title> tag content for the page, crucial for SEO.',
      },
      metaDescription: {
        type: Type.STRING,
        description:
          'A concise meta description for the page, summarizing its content for search engines.',
      },
      html: {
        type: Type.STRING,
        description:
          'The HTML content for the body of the page. Do NOT include <html>, <head>, or <body> tags. Should include GSAP-powered animations for kinetic typography and motion.',
      },
      css: {
        type: Type.STRING,
        description:
          'The complete CSS styles for the page. Do NOT include <style> tags. Should follow bold, experimental, anti-design, or brutalist aesthetics. Crucially, you MUST include a custom `::selection` style (e.g., `::selection { background-color: #your_color; color: #your_text_color; }`) that matches the site\'s unique color palette.',
      },
      js: {
        type: Type.STRING,
        description:
          'The JavaScript code for the page. Do NOT include <script> tags. Should use GSAP for all animations and interactive elements.',
      },
    },
